...
<template>
  ...
  >
    ...
    />
    <div class="ms-[17px]">
      <div class="text-[13.3px] font-bold text-veryDarkGrayishBlue">
        Michelle Appleton
      </div>
      <div class="text-[13px] font-medium text-grayishBlue">28 Jun 2020</div>
    </div>
    <div
    ...
    >
      <div
        v-if="showShareDesktop"
        class="absolute top-[-265%] flex items-center bg-veryDarkGrayishBlue z-10 w-[248px] ms-[-117px] rounded-[8px] py-[17px] justify-center after:content-[''] after:absolute after:top-[100%] after:left-[50%] after:translate-x-[-50%] after:rotate-[-90deg] after:h-[20px] after:w-[20px] after:border-[10px] after:border-[transparent_#48556a_transparent_transparent]"
      >
        <span class="text-grayishBlue text-[13px] tracking-[5px] ms-[6px]"
          >SHARE</span
        >
        <div class="flex ms-[20px] gap-4 items-center">
