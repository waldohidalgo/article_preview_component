...
<template>
  ...
  >
    ...
    <div
      class="bg-lightGrayishBlue ml-auto rounded-full p-[8px] me-[1px] cursor-pointer hover:bg-desaturatedDarkBlue group"
      title="Share"
  ...
  <div
    v-else
    class="flex items-center font-manrope p-[17px_33px_15px_32px] bg-veryDarkGrayishBlue"
  >
    <span class="text-grayishBlue text-[14px] tracking-[4px]">SHARE</span>
    ...
    <div
      class="bg-desaturatedDarkBlue ml-auto rounded-full p-[8px] me-[1px] cursor-pointer"
      title="Share"
      @click="$emit('changeShowShare')"
    >
      <svg
